...
| `real_group_layer.R`        | Gibbs sampler for Model II (tissue-group extension). Implements the group-specific coefficient updates with IG(2,0.5) prior on eta^2 and ridge stabilization. Minimum group size = 50. |
